...
public class TarifParkingDAO {
    ...
    // récupère la liste des parkings relais depuis la bdd(les gratuits mais accessibles seulement avec une carte pastel)

    public static List<String> getParkingsRelais() {
        List<String> parkingsRelais = new ArrayList<>();

        String sql = "select id_parking from parking where est_relais = true";
